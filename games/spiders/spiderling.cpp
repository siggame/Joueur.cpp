...
void Spiders::Spiderling::deltaUpdateField(const std::string& fieldName, boost::property_tree::ptree& delta)
{
    ...
    else if (fieldName == "coworkers")
    {
        this->coworkers = this->gameManager->unserializeVectorOfGameObjects<Spiders::Spiderling*>(delta, &this->coworkers);
    }
    ...
    {
        this->workRemaining = this->gameManager->unserializeInt(delta);
    }
}
