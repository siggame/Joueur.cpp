...
Game_::Game_(std::initializer_list<std::pair<std::string, Any&&>> init) :
    Base_game{
        ...
        {"dashBlock", Any{std::decay<decltype(dash_block)>::type{}}},
        ...
        {"oreRaritylegendarium", Any{std::decay<decltype(ore_raritylegendarium)>::type{}}},
    ...
    dash_block(variables_["dashBlock"].as<std::decay<decltype(dash_block)>::type>()),
    ...
    ore_raritylegendarium(variables_["oreRaritylegendarium"].as<std::decay<decltype(ore_raritylegendarium)>::type>()),
