...
Game_::Game_(std::initializer_list<std::pair<std::string, Any&&>> init) :
    Base_game{
        ...
        {"branchesToCompleteLodge", Any{std::decay<decltype(branches_to_complete_lodge)>::type{}}},
    ...
    branches_to_complete_lodge(variables_["branchesToCompleteLodge"].as<std::decay<decltype(branches_to_complete_lodge)>::type>()),
