...
public:
    ...
    /// <summary>
    /// bribes the _warehouse to light a _building on fire. _this adds this building's fire_added to their fire, and then this building's exposure is increased based on the _manhatten distance between the two buildings.
    /// </summary>
