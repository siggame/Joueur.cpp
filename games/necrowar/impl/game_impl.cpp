...
Game_::Game_(std::initializer_list<std::pair<std::string, Any&&>> init) :
    Base_game{
        ...
        {"islandUnitCap", Any{std::decay<decltype(island_unit_cap)>::type{}}},
        ...
        {"mineUnitCap", Any{std::decay<decltype(mine_unit_cap)>::type{}}},
    ...
    island_unit_cap(variables_["islandUnitCap"].as<std::decay<decltype(island_unit_cap)>::type>()),
    ...
    mine_unit_cap(variables_["mineUnitCap"].as<std::decay<decltype(mine_unit_cap)>::type>()),
