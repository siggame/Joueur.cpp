#ifndef GAMES_NECROWAR_T_JOB_H
#define GAMES_NECROWAR_T_JOB_H
...
/// Information about a tower's job/type.
/// </summary>
class T_job_ : public Game_object_
{
public:
   ...
   // ####################
   /// \cond FALSE
   T_job_(std::initializer_list<std::pair<std::string, Any&&>> init);
   T_job_() : T_job_({}){}
