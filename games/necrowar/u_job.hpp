#ifndef GAMES_NECROWAR_U_JOB_H
#define GAMES_NECROWAR_U_JOB_H
...
/// Information about a unit's job/type.
/// </summary>
class U_job_ : public Game_object_
{
public:
   ...
   // ####################
   /// \cond FALSE
   U_job_(std::initializer_list<std::pair<std::string, Any&&>> init);
   U_job_() : U_job_({}){}
